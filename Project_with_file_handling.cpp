...
void header();
void mainMenu();
void saveData(string nameArray[], string ageArray[], string phoneArray[], string genderArray[], string medical_historyArray[], string refered_doctorArray[], int number_of_testArray[], string billing_statusArray[], string commentsArray[], string emailArray[], string test_nameArray[], int index);

void loadData(string nameArray[], string ageArray[], string phoneArray[], string genderArray[], string medical_historyArray[], string refered_doctorArray[], int number_of_testArray[], string billing_statusArray[], string commentsArray[], string emailArray[], string test_nameArray[], int &index);
...
void updateRecord(string nameArray[], string ageArray[], string phoneArray[], string genderArray[],
                  string medical_historyArray[], string refered_doctorArray[], int number_of_testArray[],
                  string billing_statusArray[], string commentsArray[], string emailArray[], string test_nameArray[], int index);
...
int main()
{
    ...
    loadData(nameArray, ageArray, phoneArray, genderArray, medical_historyArray, refered_doctorArray, number_of_testArray, billing_statusArray, commentsArray, emailArray, test_nameArray, index);
                ...
                int &index, int total_Patients)
{
    if (index < total_Patients)
    {
        ...
        index++;
        saveData(nameArray, ageArray, phoneArray, genderArray, medical_historyArray, refered_doctorArray,
    ...
    if (loginsuccess)
    {
        ...
        while (true)
        {
            ...
            // calling function to update record
                ...
                updateRecord(nameArray, ageArray, phoneArray, genderArray, medical_historyArray,
                             refered_doctorArray, number_of_testArray, billing_statusArray, commentsArray, emailArray,
...
//save data is for writing data in file 
void saveData(string nameArray[], string ageArray[], string phoneArray[], string genderArray[],
              string medical_historyArray[], string refered_doctorArray[], int number_of_testArray[],
              string billing_statusArray[], string commentsArray[], string emailArray[], string test_nameArray[], int index)
{
    fstream file("patients.txt", ios::out);
    if (file.is_open())
    {
        for (int i = 0; i < index; i++)
        {
            if (nameArray[i] != "")
            {
                file << nameArray[i] << "," << ageArray[i] << "," << phoneArray[i] << "," << genderArray[i] << ","
                     << medical_historyArray[i] << "," << refered_doctorArray[i] << "," << number_of_testArray[i] << ","
                     << billing_statusArray[i] << "," << commentsArray[i] << "," << emailArray[i] << "," << test_nameArray[i] << "\n";
            }
        }
        file.close();
    }
}
//file handling to read data in file 
void loadData(string nameArray[], string ageArray[], string phoneArray[], string genderArray[],
              string medical_historyArray[], string refered_doctorArray[], int number_of_testArray[],
              string billing_statusArray[], string commentsArray[], string emailArray[], string test_nameArray[], int &index)
{
    ...
    if (file.is_open())
    {
        ...
        {
            getline(file, ageArray[index], ',');
            getline(file, phoneArray[index], ',');
            getline(file, genderArray[index], ',');
            getline(file, medical_historyArray[index], ',');
            getline(file, refered_doctorArray[index], ',');
            getline(file, temp_tests, ',');
            number_of_testArray[index] = stoi(temp_tests);
            getline(file, billing_statusArray[index], ',');
            getline(file, commentsArray[index], ',');
            getline(file, emailArray[index], ',');
            getline(file, test_nameArray[index]);
            index++;
        }
        file.close();
    }
